...
describe('/path', () => {
  it(
    `should return array with more than 3 elements for objectId = 'F59DA94B-FF9F-429E-9BAE-02334C2C98AF' and taxonomyId = '5444e7eb-177f-4faf-ba44-0e3da1b391e0'`,
    (done) => {
      const url = '/path/F59DA94B-FF9F-429E-9BAE-02334C2C98AF/5444e7eb-177f-4faf-ba44-0e3da1b391e0'
  ...
  it(
    `should return array with more than 3 elements for objectId = 'F59DA94B-FF9F-429E-9BAE-02334C2C98AF' and no taxonomyId`,
    (done) => {
  ...
  it(`should return error if taxonomyId is not an taxonomy id`, (done) => {
    const url = '/path/F59DA94B-FF9F-429E-9BAE-02334C2C98AF/F59DA94B-FF9F-429E-9BAE-02334C2C98AF'
    server.inject({ method, url }, (res) => {
      expect(res.statusCode).to.equal(400)
      done()
    })
